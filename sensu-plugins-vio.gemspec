...
require_relative 'lib/sensu-plugins-vio'
...
Gem::Specification.new do |s|
  ...
  s.homepage               = 'https://github.com/aquister/sensu-plugins-vio'
  s.license                = 'MIT'
  ...
  s.version                = SensuPluginsVIO::Version::VER_STRING
